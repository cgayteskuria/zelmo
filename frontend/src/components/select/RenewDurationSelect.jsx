...
import { renewDurationsApi } from "../../services/api";
import { useServerSearchSelect } from "../../hooks/useServerSearchSelect";

export default function RenewDurationSelect({
    filters = {},
    value,
    initialData = null,
    loadInitially = false,
    ...
    const { selectProps, defaultValue } = useServerSearchSelect({
        apiFn: (params) => renewDurationsApi.options(params),
        filters,
        loadInitially,
        initialOptions,
        selectDefault,
    ...
    return (
        <Select
            placeholder="Sélectionner une durée de renouvellement"
            {...selectProps}
