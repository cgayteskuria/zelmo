...
import { invoiceConfApi } from "../../services/api";
...
/**
 * Composant InvoiceConf
 * Formulaire de configuration des factures dans un Drawer
 */
export default function InvoiceConf({ invoiceConfId, open, onClose, onSubmit, drawerSize = "large" }) {
                    ...
                    <div className="box" style={{ marginBottom: 24 }}>
                        ...
                        <Row gutter={[16, 8]}>
                            <Col span={24}>
                                <Form.Item
                                    name="fk_eml_id"
                                    label="Compte email pour l'envoi des factures"
                                >
